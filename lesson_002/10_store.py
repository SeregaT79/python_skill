...
##########################################################################################
bad_cost = store[goods['Диван']][0]['quantity'] * store[goods['Диван']][0]['price']
# или проще (/сложнее ?)
bad_code = goods['Диван']
bad_item = store[bad_code][0]
bad_quantity = bad_item['quantity']
bad_price = bad_item['price']
bad_cost = bad_quantity * bad_price
print('Диван -', bad_quantity, 'шт, стоимость', bad_cost, 'руб')
